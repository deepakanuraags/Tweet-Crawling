...
access_token = '1166721367619899392-pHVNKXpkrNrs2iWwaE7fc9i234fvURboP'
access_token_secret = 'IuQfuEiZG3hDj8hWmtsq9OLnQhWosTTsNi4V23Gwn14zfsx'
consumer_key = 'vQjLuPJ1wvmLhiJZrS2bvSTfadfdC'
consumer_secret = 'SpKUPIbajh67ytpqb1YqT7I0Kaafdqb7QI4TGBFRElOtTOKCwnY1TV'
...
if __name__ == '__main__':
    ...
    crawlTweets = loadReplyTweets()
    crawlTweets.loadRepliesForPOITweets(1168343827901554688,1168517896634585089,'ewarren','en','USA')